...
\newtcolorbox[auto counter, number within=subsection, list inside=cases]{casedetails}[1]{fonttitle = \bfseries, coltitle = Black, frame hidden, colback = White, colbacktitle=Gray!10, title={#1}, enhanced, breakable, skin first=enhanced, skin middle=enhanced, skin last=enhanced}

\newtcolorbox[auto counter, number within=subsection, list inside=conventions]{conventiondetails}[1]{fonttitle = \bfseries, coltitle = Black, frame hidden, colback = White, colbacktitle=Gray!10, title={#1}, enhanced, breakable, skin first=enhanced, skin middle=enhanced, skin last=enhanced}

\newtcolorbox[auto counter, number within=subsection, list inside=statute]{statutedetails}[1]{fonttitle = \bfseries, coltitle = Black, frame hidden, colback = White, colbacktitle=Gray!10, title={#1}, enhanced, breakable, skin first=enhanced, skin middle=enhanced, skin last=enhanced}
