...
\begin{statutedetails}{\textit{Statute of the International Court of Justice} Art 38}
    \flushleft
    \begin{enumerate}
...
\begin{casedetails}{\textit{Ure v Commonwealth} (2016) 329 ALR 452}
    \flushleft
...
\begin{casedetails}{\textit{R (app. Al-Saadoon v Sec. of Defence)} [2010] 1 All ER 271}
    \flushleft
...
\begin{itemize}
    \item This is a fairly narrow doctrine under customary interntional law
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Influencing the creation of new customary norms (e.g., a resoltion can be the spark that creates a new customary norm)
    \end{enumerate}
\end{itemize}
...
\begin{casedetails}{\textit{Legality of the Threat or Use of Nuclear Weapons} [1996] ICJ Rep 254}
    \flushleft
