...
\begin{statutedetails}{\textit{Statute of the International Court of Justice} Article 38}\label{ICJ Statute Art 38}
    \flushleft
    \begin{enumerate}
...
\begin{casedetails}{\textit{Nicaragua v Colombia} [2023] ICJ Rep 413}\label{case:Nicaragua v Colombia}
    \flushleft
...
\begin{itemize}
    ...
    \item A state cannot be a persistent objector to a \textit{jus cogens} principle, following the \article{International Law Commission's} 2019 report, at \article{Conclusion 14 of Chapter V}
\end{itemize}
...
\begin{casedetails}{\textit{Bay of Bengal (Bangladesh/Myanmar)} [2012] ILTOS 12}\label{case:Bangladesh v Myanmar}
    \flushleft
    ...
    \begin{longtable}{r|>{\raggedright\arraybackslash}p{0.85\textwidth}}
...
\begin{casedetails}{\textit{Chagos Marine Protected Area Arbitration (Mauritius v United Kingdom)} (2015) XXXI RIAA 359}\label{case:Chagos Marine Protected Area Arbitration}
    \flushleft
...
\begin{itemize}
    ...
    \item Decisions taken by the ICJ do not constitute binding precedent in future decisions, and remain merely persuasive, following Art 59 of the \statute{\textit{Statute of the International Court of Justice}}
...
\begin{casedetails}{\textit{The Paquete Habana} 175 US 677 (1900) (United State Supreme Court)}\label{case:Paquete Habana}
    \flushleft
...
\begin{conventiondetails}{\textit{Charter of the United Nations} Article 25}\label{UN Charter Art 25}
    \flushleft
