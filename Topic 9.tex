...
\begin{statutedetails}{\textit{Rome Statute of the International Criminal Court} Art 13}
    \flushleft
...
\begin{itemize}
    \item \convention{\textit{VCDR} Art 3} sets out the primary functions of a diplomatic mission, which includes:
    \begin{itemize}
...
\begin{conventiondetails}{\textit{1961 Vienna Convention on Diplomatic Relations} Art 6}
    \flushleft
...
\begin{conventiondetails}{\textit{1961 Vienna Convention on Diplomatic Relations} Art 10}
    \flushleft
    \begin{enumerate}
...
\begin{conventiondetails}{\textit{1961 Vienna Convention on Diplomatic Relations} Art 12}
    \flushleft
...
\begin{conventiondetails}{\textit{1961 Vienna Convention on Diplomatic Relations} Art 15}
    \flushleft
...
\begin{itemize}
    \item Under \convention{\textit{VCDR} Art 22(1)}, the premises of the diplomatic mission are inviolable and may not be entered without the consent of the head of the mission
...
\begin{itemize}
    \item Under \convention{\textit{VCDR} Art 22(2)}, the receiving state is under a special duty to take all appropriate steps to protect the premises of the mission against any intrusion or damage and to prevent any disturbance of the peace of the mission or impairment of its dignity
...
\begin{conventiondetails}{\textit{1961 Vienna Convention on Diplomatic Relations} Art 37}
    \flushleft
    \begin{enumerate}
...
\begin{conventiondetails}{\textit{1961 Vienna Convention on Diplomatic Relations} Art 39}
    \flushleft
    \begin{enumerate}
