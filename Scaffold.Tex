...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \begin{enumerate}
                \item Traditionally, this vitiates the consent of the state to the treaty as a whole and results in the state not being a party to the treaty (this is the predominant view) -- \case{\textit{Reservations to Genocide Convention} [1951] ICJ Rep 15 at page 18}
    ...
    \begin{enumerate}[resume]
        ...
        \begin{enumerate}
            \item Under the principle of \textit{pacta servanda sunt} (\article{VCLT Art 26} on Page \pageref{VCLT Art 26}), the party must have exhausted all possible avenues before claiming a fundamental change of circumstances
